...
class Main():
    ...
    def start_rcm_method(self):
        ...
        if self.rcm.get_port() in [30001, 30002, 30003, 29999]: self.rcm.begin(mode="client"); print("client mode")
